...
window.onload = function () {
	...
	document.getElementById("renImg").onmouseover = function () {
		document.getElementById("renImg").src = "img/ren1.gif";
	}
	...
	document.getElementById("aboutImg").onmouseover = function () {
		document.getElementById("aboutImg").src = "img/about1.gif";
	}
	...
	document.getElementById("insImg").onmouseout = function () {
		document.getElementById("insImg").src = "img/ins.gif";
	}
...
function modo1() {
	if (y <= -1) {
		document.getElementById('naveimg').src = "img/fuego.gif";
		partida = 0;
		stop();
	}
	if (altur <= 0 && veloc > 5) {
...
function cambiar() {
	if (partida == 1) {
		document.getElementById('naveimg').src = "img/navefue.gif";
	}
}
